...
resourcestring
  ...
  srcut025b = 'Show in a form the picture contained in a Markdown image link at the beginning of the ' +
       'current paragraph (Esc to close).';
  srcut025c = 'Show in the text the picture contained in a Markdown image link at the beginning of the ' +
       'current paragraph.';
  ...
  srcut056b = 'In the detail grid, add the selected item.';
  srcut056c = 'Insert the citation in the grid.';
  srcut056d = 'Close the form.';
...
begin
  ...
  Inc(i);
  sgShortcuts.Cells[0, i] := 'Meta + Opt + Shift + P';
  sgShortcuts.Cells[1, i] := srcut025c;
  Inc(i);
  ...
  Inc(i);
  sgShortcuts.Cells[0, i] := 'Meta + Shift + G';
  sgShortcuts.Cells[1, i] := srcut039b;
  Inc(i);
  sgShortcuts.Cells[0, i] := 'Meta + Opt + ' + srcut00a;
  ...
  Inc(i);
  sgShortcuts.Cells[0, i] := 'Esc';
  sgShortcuts.Cells[1, i] := srcut056d;
  Inc(i);
  Inc(i);
