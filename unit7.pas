...
resourcestring
  ...
  srcut052 = 'Sort alphabetically - and not numerically - the content of the ' +
    'current column in the current table, after confirmation;';
  srcut052b = 'if the current table is not followed by another table, ' +
    'mark its bottom row creating a fictional table after it, even writing just its title.';
