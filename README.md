...
Here are available two podcasts on mxMarkEdit generated by the author using Google NotebookLM in January 2025. Every podcast is about 20 minutes long and is in English. The two podcasts describe the functionalities of the app in different ways.

- [First podcast](https://drive.google.com/file/d/1-_rx8I8XkS5_BSKV_4nNchrt863EKNAP/view?usp=sharing).

- [Second podcast](https://drive.google.com/file/d/16AkUqrHUaZ6PFOfAQzfN06zh8XHf66JS/view?usp=sharing).
...
Anyway, when the link is formatted as a proper Markdown link, like `[my web site](www.mywebsite.com)`, it's not possible to add the `` ` `` character before and after the link, because when exported in a word processor through Pandoc those characters would made the link wrong and ineffective.
